...
export const exampleRepos: RepoEntry[] = [
  // — Partners (priorité hackathon) —
  { name: "Alpic Skybridge", url: "https://github.com/alpic-ai/skybridge", emoji: "🚀" },
  { name: "Gradium", url: "https://github.com/gradium-ai/gradium-py", emoji: "🎙️" },
  { name: "OpenAI Cookbook", url: "https://github.com/openai/openai-cookbook", emoji: "🧠" },
